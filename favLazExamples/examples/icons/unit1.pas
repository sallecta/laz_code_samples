...
begin
  Image1.Picture.LoadFromFile(ExtractFilePath(ParamStrUTF8(0)) + '../icons/lazarus.ico');
  UpdateTrackbar;
end;

procedure TForm1.Button2Click(Sender: TObject);
begin
  Image1.Picture.LoadFromFile(ExtractFilePath(ParamStrUTF8(0)) + '../icons/lazarus.icns');
  UpdateTrackbar;
end;
